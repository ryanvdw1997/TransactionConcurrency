...
public interface Transaction extends AutoCloseable {
    ...
    /**
     * @return Object representing the `tables` table used to store table information
     */
    Table getTableInfo();

    /**
     * @return Object representing the `indices` table used to store index information
     */
    Table getIndexInfo();
}
